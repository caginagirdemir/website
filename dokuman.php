...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			...
			<div class="content">
                ...
                <td style="text-align: center;"><img style="border: 0;" src="images/1388668308_user_add.png" width="24" height="24" /></td>
                </tr>
                <?php
                session_start();
                  ...
                  $dok = mysql_query("select * from dok where dok_durum='aktif'");
	...
	<td style="text-align: center;"><?php echo $doksonuc['dok_indirme']; ?></td>
