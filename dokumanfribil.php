...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			<h1 class="title">Döküman Bildir</h1>
			<div class="content">
				<p>
                <?php
...
$mail->Subject = "caginagirdemir@gmail.com | Döküman Bildirimi";
$mail->IsHTML(true);
$body = "<img src='http://www.caginagirdemir.com/images/mail.png' /><br />";
$body .= "Sistemem Eklenen Bir Döküman Ýçin Takipçimizi Bilgilendirelim Ýstedik. <br/>";
$body .= "<strong>Eklenen Döküman Adý :</strong>".$_SESSION['dok_ad']."<br/>";
$body .= "Dökümana Takipçi Giriþinden Sonra Sitede Dökümanlar Bölümünden Ulaþabilirsiniz.";
$body .= "caginagirdemir.com | Döküman Bildirim Sistemi";
                  ...
                  $takipciveri3 = mysql_query("select * from takipci where takipci_erisim='1388430621_users.png'");
                  while($takipciresult2=mysql_fetch_array($takipciveri3))
                  {
                ?>
                <table>
<tr>
	<td><?php echo $takipciresult2['takipci_ad']; ?></td>
	<td><?php echo $takipciresult2['takipci_mail']; ?></td>
	<td><?php
    $mail->SetFrom($takipciresult2['takipci_mail'],$takipciresult2['takipci_ad']);
$mail->Body=$body;
if($mail->Send()) {
    echo "<img style='border: 0;' src='images/1388674094_like.png' width='24' height='24' />";
} else {
    echo $mail->ErrorInfo;
}
    ?></td>
