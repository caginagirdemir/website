...
<?php
                  ...
                  $sorgu = "select * from haber where haber_id=".$_GET['id'];
                  $habersonuc = mysql_query($sorgu);
                  $sonuc2 = mysql_fetch_assoc($habersonuc);
                  
?>
<div id="page">
	<div id="content">
		<div class="feature bg7">
			<h1 class="title"><?php echo $sonuc2["haber_baslik"]; ?></h1>
			<div class="content">
				<p><?php echo $sonuc2["haber_icerik"]; ?></p>
                <p style='color: #AC150D;'><?php echo $sonuc2["haber_tarih"]; ?></p>
			</div>
		</div>
		<div class="box">
		</div>
