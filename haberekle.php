...
<tr>
    ...
    $fckeditor = new FCKeditor('haber_icerik');   //buradaki 'yazi' text alanýmýzýn name="yazi" deðerini belirleyecek
    $fckeditor->BasePath = '/fckeditor/' ; //fckeditör'ün kurulu olduðu dosya(Ýndirdiðiniz dosya)
    $fckeditor->Value = 'Default Value' ;      //Editörümüz yüklendiðindeki default deðeri
    $fckeditor->Width = '700';             //FckEditör'ün geniþliði.
    $fckeditor->Height = '300';            //FckEditör'ün yüksekliði.
    $fckeditor->ToolbarSet = 'Custom';
    $fckeditor->Value = '';
    $fckeditor->Create() ; //fckeditör oluþtur
    ?></td>
</tr>
<tr>
	<td>haber_tarih</td>
