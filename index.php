...
<div id="page">
	<div id="content">
		<div class="feature bg7">
         ...
         // mysql_query ("SET COLLATION_CONNECTION = 'utf-8_bin'");
                  $sorgu = mysql_query("select * from event order by event_id desc limit 17");
                  while($sonucevent=mysql_fetch_array($sorgu))
                  {
                    if($sonucevent['event_resim'] == '1391531135_user_add.png')
                    {
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_icerik']." Adında Bir Takipçimiz Siteye Eklenmiştir.</td>";
                        echo "</tr>";
                        echo "<tr>";
                    ...
                    if($sonucevent['event_resim'] == '1391531127_rss_add.png')
                    {
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_icerik']." Başlıklı Bir Haber Eklendi.</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_tarih']."</td>";
                        echo "</tr>";
                    ...
                    if($sonucevent['event_resim'] == '1391531260_note_add.png')
                    {
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_icerik']." Başlıklı Bir Döküman Eklendi.</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_tarih']."</td>";
                        echo "</tr>";
                    ...
                    if($sonucevent['event_resim'] == '1391531304_bullet_info.png')
                    {
                        ...
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_icerik']." Başlıklı Bir Video Eklendi.</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td>".$sonucevent['event_tarih']."</td>";
                        echo "</tr>";
                    ...
                    {
                        echo "<tr>";
                        echo "<td><img style='border: 0;' src='images/1391534517_arrow_refresh.png' width='32' height='32' /> <b>Takipçi Bilgilerinde Değişiklik</b></td>";
                        echo "</tr>";
                        echo "<tr>";
		...
		<ul>
			<li id="menu" class="bg6">
				...
				<ul>
					...
					<li><a href="hakkimda.php" accesskey="5" title="">Hakkımda</a></li>
					<li><a href="arsiv.php" accesskey="6" title="">Arşiv</a></li>
				</ul>
			</li>
			<li id="news">
			...
			<li id="archives">
                ...
                session_start();
                 ...
                 if ($_SESSION['takipci_id'] == null)
                 {echo "<li class='first'><a href='takipcigiris.php'>Takipçi Giriş</a> <i></i></li>";
                  echo "<li class='first'><a href='fgiris.php'>Facebook Girişi</a> <i></i></li>";
                  echo "<li class='first'><a href='g+giris.php'>Google+ Girişi</a> <i></i></li>";
                  echo "<li class='first'><a href='takipciekle.php'>Takipçi Ol</a> <i></i></li>";
                  echo "<li class='first'><a href='sifremihatirlat.php'>Şifremi Unuttum</a> <i></i></li>";}
                ?>
