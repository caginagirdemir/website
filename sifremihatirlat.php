...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			<h1 class="title">Şifre Hatırlatma</h1>
			<div class="content">
				<p>
                <table>
                <form action="sifremiunuttump.php" method="post" enctype="multipart/form-data">

               
<tr>
<td> Mail Adresiniz </td>
	<td><input type="text" size="25" name="hatirlatmail" /></td>
	<td><input type="submit" value="hatirlat" /></td>
</tr>
</form> 
</table>
<p style="color: #36743A;"></p>
<?php
if(isset($_GET['id']))
{
    if($_GET['id'] == "sucsess")
    {
        echo "<p style='color: #36743A;'>Şifreniz Mailinize Gönderilmiştir Lütfen Mailinizi Kontrol Ediniz</p>";
    }
    if($_GET['id'] == "fail")
    {
        echo "<p style='color: #722321;'>Mail Gönderilemedi Lütfen Daha Tekrar Deneyiniz<br/>Eğer Sonuç Alamazsanız caginagirdemir@gmail.com Adresine Mail İle Bildirin</p>";
    }
    if($_GET['id'] == "fail2")
    {
        echo "<p style='color: #722321;'>Mail Bulunamadı Lütfen Kontrol Ediniz</p>";
    }
}
?>
                </p>
