...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			<h1 class="title">Takipçi Editle</h1>
			<div class="content">
				<p>
                <table>
                <?php
                session_start();
                  ...
                  $takipci1 = mysql_query("select * from takipci");
                  while($takipci = mysql_fetch_array($takipci1))
                  {
                  ?>
                  <tr>
                  <?php
                  if($takipci['takipci_erisim'] == "1388430649_earth.png")
                  {
                    echo "<td><a href='takipcieditark.php?id=".$takipci['takipci_id']."'>Ark</a></td>";
                  }
                  else
                  {
                    echo "<td></td>";
                  ...
                  ?>
                  <td><a href="takipcieditsil.php?id=<?php echo $takipci['takipci_id']?>">Sil</a></td>
                  <td><a href="takipcieditduz.php?id=<?php echo $takipci['takipci_id']?>">Düzenle</a></td>
	<td style="width: 100%; "><?php echo $takipci['takipci_id']; ?></td>
	<td style=""><?php echo $takipci['takipci_ad']; ?></td>
	<td><?php echo $takipci['takipci_mail']; ?></td>
	<td><img style="border: 0;" src="images/<?php echo $takipci['takipci_erisim']; ?>" width="24" height="24" /></td>
	<td style="left: inherit;"><?php echo $takipci['takipci_sifre'] ?></td>
</tr>
<?php } ?>
</table>
                </p>
