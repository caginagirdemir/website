...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			<h1 class="title">Takipçi Giriþ</h1>
			<div class="content">
            <form action="takipcigirisp.php" method="post" enctype="multipart/form-data">
...
<tr>
	<td>Takipçi_Þifre</td>
	<td><input type="password" size="25" name="takipci_sifre" /></td>
</tr>
</table>
<input type="submit" value="giris" /></p>
</form>
<?php
if(isset($_GET['id']))
{
    echo "<p style='color: #AC150D;'>Mail ve Þifrenizi Kontrol Ediniz</p>";
}
?>
			</div>
		</div>
