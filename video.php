...
<div id="page">
	<div id="content">
		<div class="feature bg7">
			...
			<div class="content">
	<p>
    <p> Seçtiðiniz Video Sayfanýn Altýnda Açýlacaktýr. </p>
    <table>
    <?php
                  ...
                  session_start();
                  $dok = mysql_query("select * from video");
                  while($doksonuc = mysql_fetch_array($dok))
                  {
                  ?>
                  <tr>
	<td><a href="video.php?id=<?php echo $doksonuc['video_id'];?>"><?php echo $doksonuc['video_ad']; ?></a></td>
</tr>
...
if(isset($_GET['id']))
{
     $video1 = mysql_query("select * from video where video_id=".$_GET['id']);
     $video = mysql_fetch_assoc($video1);
     echo $video['video_ad'];
